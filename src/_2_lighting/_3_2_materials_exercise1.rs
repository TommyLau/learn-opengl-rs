...
pub fn main_2_3_2() {
    ...
    while !window.should_close() {
        ...
        unsafe {
            ...
            // light properties
            lighting_shader.set_vec3("light.ambient", 1.0, 1.0, 1.0); // note that all light colors are set at full intensity
            lighting_shader.set_vec3("light.diffuse", 1.0, 1.0, 1.0);
